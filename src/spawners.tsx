...
var spawners:spawners= {
    ...
    "spewer 2" : [{
        ...
        y : () => 0,
        loop:true
    },"spewer",1, 0.5,["spewer"],"Spewer rate of fire increased"], 
    ...
    "spewer 3" : [{
        ...
        y : () => 0,
        loop:true
    },"spewer",2, 1,["spewer 2"],"Spewer has 2 hp"], 
    ...
    "strafe 3" :  [{
        ...
        y : () => Math.random() * 100+100,
        loop:true
    },"strafe",2, 0.9, ["strafe 2"], "Strafer spawn time decreased", "strafe"],
